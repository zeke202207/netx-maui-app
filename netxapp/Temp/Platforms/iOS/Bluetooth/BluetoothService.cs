    ...
    public static partial class BluetoothService
    {
        ...
        private class BluetoothDelegate : CBCentralManagerDelegate
        {
            ...
            public override void UpdatedState(CBCentralManager central)
            {
                ...
                BluetoothService.UpdatedState?.Invoke(central, EventArgs.Empty);
            ...
            public override void ConnectedPeripheral(CBCentralManager central, CBPeripheral peripheral)
            {
                ...
                BluetoothService.ConnectedPeripheral?.Invoke(central, new CBPeripheralEventArgs(peripheral));
            }

            public override void DisconnectedPeripheral(CBCentralManager central, CBPeripheral peripheral, NSError error)
            {
                System.Diagnostics.Debug.WriteLine($"Disconnected {peripheral.Identifier} {error}");
                BluetoothService.DisconnectedPeripheral?.Invoke(central, new CBPeripheralErrorEventArgs(peripheral, error));
            }
            public override void FailedToConnectPeripheral(CBCentralManager central, CBPeripheral peripheral, NSError error)
            {
                System.Diagnostics.Debug.WriteLine($"Failed to connect {peripheral.Identifier} {error.Code}");
                BluetoothService.FailedToConnectPeripheral?.Invoke(central, new CBPeripheralErrorEventArgs(peripheral, error));
            }
        }
