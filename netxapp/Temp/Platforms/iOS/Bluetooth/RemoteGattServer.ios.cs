...
namespace netxapp.Services
{
    partial class RemoteGattServer
    {
        ...
        {
            if (Device != null)
            { BluetoothService._manager.ConnectPeripheral(Device); }
        }
        ...
        Task PlatformConnect()
        {
            ...
            void connectedHandler(object sender, CBPeripheralEventArgs e)
            {
                ...
                {
                    BluetoothService.ConnectedPeripheral -= connectedHandler;
                    BluetoothService.FailedToConnectPeripheral -= failedConnectHandler;
                    tcs.SetResult(true);
                }
            };
            ...
            {
                BluetoothService._manager.ConnectPeripheral(Device, new CBConnectPeripheralOptions { RequiresAncs = Device.RequiresAncs });
            }
            else
            {
#endif
            ...
            switch (((CBPeripheral)Device).State)
            {
                ...
                default:
                    BluetoothService._manager.CancelPeripheralConnection(Device);
                    return Task.CompletedTask;
            }
        }
